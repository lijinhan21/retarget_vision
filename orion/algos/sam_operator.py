...
class SAMOperator:
    def __init__(self, 
                 model_type="vit_b",
                 checkpoint=os.path.join(ROOT_PATH, "../" "third_party/sam_checkpoints/sam_vit_b_01ec64.pth"),
                 sam_config_file=os.path.join(ROOT_PATH, "vision_model_configs", "sam_config.yaml"),
                 device="cuda:0", 
