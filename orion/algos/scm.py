...
from orion.utils.misc_utils import get_palette, resize_image_to_same_shape
...
class ObjectSegmentationCorrespondenceModel(nn.Module):
    def __init__(self,
    ...
    def forward(self, 
        ...
        hungarian_matrix = np.zeros((max_mask_id, max_mask_id))
...
class SAMSegmentationCorrespondenceModel(nn.Module):
    """
    This model creates corresondence between an annotated image and an unannotated image. 
    The object segments from the unannotated image is given by Segment-Anything model.
    """
    def __init__(self,
                 dinov2: DinoV2ImageProcessor = None,
    ...
    def forward(self, 
        ...
        # sam_masks is a list of numpy arrays, each array is a binary image scaled to {0, 255} values.
