...
from orion.utils.misc_utils import VideoWriter
...
class DinoV2ImageProcessor(object):
    def __init__(self, args=None):
        if args is None:
            ...
            self.args.config_file = os.path.join(ROOT_PATH, "../", "third_party/dinov2/dinov2/configs/eval/vitb14_pretrain.yaml")
            # self.args.pretrained_weights = "https://dl.fbaipublicfiles.com/dinov2/dinov2_vitl14/dinov2_vitl14_pretrain.pth"
            # self.args.config_file = os.path.join(ROOT_PATH, "../", "third_party/dinov2/dinov2/configs/eval/vitl14_pretrain.yaml")
            # self.args.pretrained_weights = "https://dl.fbaipublicfiles.com/dinov2/dinov2_vitb14/dinov2_vitb14_reg4_pretrain.pth"
            # self.args.config_file = os.path.join(ROOT_PATH, "../", "third_party/dinov2/dinov2/configs/eval/vitb14_reg4_pretrain.yaml")            
        else:
            self.args = args
        # print("*****")
        print(self.args)
    ...
    def process_image(self, img, sizes = [448, 336, 224], weights=[1.0, 0.2, 0.2]):
        ...
        features = torch.einsum("b,bhwc-> hwc", weights, features)
    ...
    def process_images(self, imgs):
        seq_features = []
        for img in imgs:
            single_image_features = self.process_image(img)
            seq_features.append(single_image_features)
