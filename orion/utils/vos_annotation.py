...
from orion.utils.misc_utils import VideoWriter, convert_convention

import init_path
from orion.algos.xmem_tracker import XMemTracker
from orion.algos.misc_utils import get_annotation_path, get_first_frame_annotation, VideoWriter


def video_vos_annotation(cfg,
                         )
